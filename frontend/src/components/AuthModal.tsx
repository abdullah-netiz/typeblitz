    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="modal-subtitle">
          {isLogin ? 'Sign in to sync your stats' : 'Join TypeBlitz to save your progress'}
        </p>

        <div className="social-auth">
          <button className="social-btn google" onClick={() => handleSocialSignIn('google')} disabled={loading}>
          ...
          <button className="social-btn github" onClick={() => handleSocialSignIn('github')} disabled={loading}>
        ...
        <div className="modal-footer">
          {isLogin ? (
            <p>No account? <button onClick={() => setIsLogin(false)}>Sign up</button></p>
          ) : (
